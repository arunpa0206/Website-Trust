...
<form role="search" method="get" class="woocommerce-product-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<button class="search-button" type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'bighearts' ); ?>"><?php echo esc_html_x( 'Search', 'submit button', 'bighearts' ); ?></button>
