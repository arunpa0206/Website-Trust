...
if ( !class_exists('ReduxFramework_custom_header_builder') ) {
    ...
    class ReduxFramework_custom_header_builder
    {
                ...
                foreach ( $sortlists as $group => $sortlist ) {
                    ...
                    <div id="wgl_modal_builder_items" style="display:none;">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2><?php
                                echo apply_filters( "wgl-changed-text-modal-window-{$this->parent->args['opt_name']}", __( 'WGL Select Item', 'bighearts-core' ) );
                                ?></h2>
                            </div>
                        ...
                        echo '<div class="wgl_header_row-btn">';
                            ...
                            echo '<div class="wgl_header_row-toggle"><a href="#" title="'.apply_filters("wgl-toggle-row-text", __( 'Toggle row', 'bighearts-core' )).'"><i class="wgl_arrow"></i></a></div>';

                            echo '<div class="wgl_header_row-disabled"><a href="#" title="'.apply_filters("wgl-disabled-row-text", __( 'Disabled row', 'bighearts-core' )).'"><i class="fa fa-desktop"></i></a>';
                            ...
                            echo '<div class="wgl_header_row-opt" data-section-opt="'.$row_opt_id.'"><a href="#" title="'.apply_filters("wgl-edit-row-text", __( 'Edit this row', 'bighearts-core' )).'"><i class="fas fa-pen fa"></i></a></div>';
                        echo '</div>';
                    }
                    ...
                    if($index != 0){
                        ...
                        */
                        ...
                        echo '<span class="edit_column" data-opt-col-id="'.esc_attr($column_opt_id).'"><a href="#" title="'.apply_filters("wgl-edit-column-text", __( 'Edit this column', 'bighearts-core' )).'"><i class="fas fa fa-pen" aria-hidden="true"></i></a></span>';

                        echo '<span class="add_item"><a href="#" title="'.apply_filters("wgl-add-item", __( 'Add Item', 'bighearts-core' )).'"><i class="fas fa-plus" aria-hidden="true"></i></a></span>';
                    }
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <span class="close close-btn"><?php
                                echo apply_filters( "wgl-close-text-modal-window-{$this->parent->args['opt_name']}", __( 'Save Changes', 'bighearts-core' ) );
                            ?></span>
                            <h2><?php
                            echo apply_filters( "wgl-changed-text-modal-window-{$this->parent->args['opt_name']}", __( 'WGL Header Options', 'bighearts-core' ) );
                            ?></h2>
                        </div>
                        <div class="modal-body">
                        </div>
        ...
        public function enqueue() {
            ...
            $vars = array(
                'delete' => __( 'Are you sure want to delete the element?', 'bighearts-core' ),
            );
