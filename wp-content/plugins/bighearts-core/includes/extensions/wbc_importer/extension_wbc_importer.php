    ...
    class ReduxFramework_extension_wbc_importer
    {
                        ...
                        foreach ( $import['files'] as $file ) {
                            switch ( $file['name'] ) {
                                ...
                                case 'give_form_sql.json':
                                    $this->wbc_import_files['wbc-import-'.$x]['give_form'] = $file['name'];
                                    break;
        ...
        function add_importer_section()
        {
            ...
            $this->parent->sections[] = array(
                ...
                'desc'   => '<p>'. apply_filters( 'wbc_importer_description', __( 'Works best on a new install of WordPress. <br><strong>Images are not included in demo import.</strong> If you want to use images from demo content, you should check the license for every single image.', 'framework' ) ).'</p>',
                'icon'   => 'el-icon-share',
                'fields' => array(
                    array(
